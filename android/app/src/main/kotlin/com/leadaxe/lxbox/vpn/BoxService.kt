        ...
        override fun onReceive(context: Context, intent: Intent) {
            ...
            when (intent.action) {
                ...
                Intent.ACTION_SCREEN_ON -> {
                    // SCREEN_OFF always pauses the core's device-aware tickers.
                    // Wake unconditionally as its exact pair: SPEC 054 uses this
                    // edge to probe the selected urltest node immediately, while
                    // the 30s ticker remains stopped with the screen off.
