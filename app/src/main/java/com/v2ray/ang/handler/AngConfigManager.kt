...
object AngConfigManager {
    ...
    private fun fetchSubscriptionResponse(
        ...
        var response = try {
            ...
            lastError = e.message?.takeIf { it.isNotBlank() } ?: "ошибка сети"
        ...
        return if (response?.content.isNullOrEmpty()) {
            SubscriptionFetchAttempt(response, lastError)
        } else {
